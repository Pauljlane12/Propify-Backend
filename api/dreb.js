...
export default async function drebHandler(req, res) {
  console.log("🔥 /api/dreb was hit:", req.body);
  ...
  try {
    ...
    console.log(
      "🚀 Final dreb insights payload:",
      JSON.stringify(insights, null, 2)
    );

    return res.status(200).json({ player, line, direction, insights });
  } catch (err) {
    console.error("❌ Unhandled error in /api/dreb:", err);
