...
export default async function raHandler(req, res) {
  console.log("🔥 RA request hit with:", req.body);
  ...
  try {
    ...
    console.log("✅ RA insights payload:", JSON.stringify(insights, null, 2));
